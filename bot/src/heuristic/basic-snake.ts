...
import { coord, GameContext } from "./prelude";

export function basicSnake(gameState: GameState): MoveResponse {
    const world = GameContext.fromGameState(gameState);
 ...
 * @returns Coord[][]
 */
export function bfsPathsToFood(world: GameContext, state: GameState): Coord[][] {
